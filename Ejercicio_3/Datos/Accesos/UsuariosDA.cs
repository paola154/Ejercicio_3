...
namespace Datos.Accesos
{
    ...
    {
        readonly string cadena = "Server=localhost; Port=3306; Database=programacionejercicio; Uid=root;Pwd=Paola_2001.20;";
        ...
        public bool ModificarUsuario(Usuarios usuario)
        {
            ...
            try
            {
                string sql = "UPDATE usuarios SET Codigo = @Codigo, Nombre = @Nombre, Edad = @Edad, Rol = @Rol, Profesion = @Profesion, Estado = @Estado, Clave = @Clave WHERE Codigo = @Codigo;";
